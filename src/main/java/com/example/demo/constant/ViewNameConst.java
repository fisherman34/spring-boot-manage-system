...
public class ViewNameConst {
  ...
  /** 商品情報登録画面_成功時 */
  public static final String MERCHANDISE_REGIST_SUCCESS = "merchandiseRegistSuccess";

  /** 商品情報登録画面_失敗時 */
  public static final String MERCHANDISE_REGIST_ERROR = "merchandiseRegistErr";
  ...
  /** 商品編集画面_エラー時 */
  public static final String MERCHANDISE_EDIT_ERROR = "merchandiseEditError";
