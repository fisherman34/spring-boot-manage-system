...
public class MessageConst {
  ...
  /** 商品情報編集画面：商品登録失敗 */
  public static final String MERCHANDISE_REGIST_FAILED = "merchandise.registFailed";

  /** 商品情報編集画面：商品登録完了 */
  public static final String MERCHANDISE_REGIST_SUCCEED = "merchandise.registSucceed";

  /** 商品情報編集画面：既に登録済み */
  public static final String MERCHANDISE_ALREADY_EXISTED = "merchandise.alreadyCompleted";

  /** 商品情報編集画面：商品更新失敗 */
  public static final String MERCHANDISEEDIT_UPDATE_FAILED = "merchandiseEdit.updateFailed";

  /** 商品情報編集画面：商品更新完了 */
  public static final String MERCHANDISEEDIT_UPDATE_SUCCEED = "merchandiseEdit.updateSucceed";

  /** 商品詳細画面：存在しない商品ID */
  public static final String NON_EXISTED_MERCHANDISE_ID = "merchandiseDetail.nonExistedMerchandiseId";

  /** 商品詳細画面（削除）：存在しない商品ID */
  public static final String MERCHANDISEDETAIL_NON_EXISTED_LOGIN_ID = "merchandiseDetail.deletenonExistedMerchandiseId";

  /** 商品詳細画面（削除）：商品削除完了 */
  public static final String MERCHANDISEDETAIL_DELETE_SUCCEED = "merchandiseDetail.deleteSucceed";
